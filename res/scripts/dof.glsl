...
float ndofstart = 1.0; //near dof falloff start
float ndofdist = 2.0; //near dof falloff distance
float fdofstart = 3.0; //far dof falloff start
float fdofdist = 6.0; //far dof falloff distance

float CoC = 0.3;//circle of confusion size in mm (35mm film = 0.03mm)
...
void main() 
{
    ...
    if(blur < 0.1) //some optimization thingy
    {
